...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TEST___Dev",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10TEST___Dev11AppDelegate")
...
SWIFT_CLASS("_TtC10TEST___Dev13SceneDelegate")
...
SWIFT_CLASS("_TtC10TEST___Dev14ViewController")
